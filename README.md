...
To use arcgis-webpack-plugin instead of esri-loader to load the ArcGIS API for JavaScript modules, check out the [`@arcgis-webpack-angular`](https://github.com/Esri/esri-map-query/tree/arcgis-webpack-angular) branch of this repo.
...
```bash
  git clone https://github.com/andygup/esri-map-query.git
```
